...
namespace BizHawk.BizInvoke
{
	public static class BizInvoker
	{
		...
		/// <exception cref="InvalidOperationException"><see cref="GetInvoker{T}(BizHawk.Common.IImportResolver,BizHawk.Common.IMonitor,BizHawk.BizInvoke.ICallingConventionAdapter)"/> previously called with <paramref name="dll"/></exception>
